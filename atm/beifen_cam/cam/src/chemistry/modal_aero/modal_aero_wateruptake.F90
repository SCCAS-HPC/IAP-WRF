...
!!      print*, '====== At sub. modal_aero_wateruptake_sub: lchnk =', lchnk
!!      if (lchnk == 1155) print*, '======= At sub. modal_aero_wateruptake_sub: lchnk =', lchnk
!======================== zhh debug 2012-02-08 =======================
...
!======================== zhh debug 2012-02-08 =======================
!            if ( lchnk == 1155 .and. i==7 .and. k==1 .and. m==1 ) then
!               print*, '============ At sub. modal_aero_wateruptake_sub =================='
!               print*, 'dgncur_a(7,1,1) =', dgncur_a(7,1,1)
!               print*, 'dgncur_a(7,1,2) =', dgncur_a(7,1,2)
!               print*, 'dgncur_a(7,1,3) =', dgncur_a(7,1,3)
!            endif
!            if ( lchnk == 1155 .and. i==8 .and. k==1 .and. m==1 ) then
!               print*, 'dgncur_a(8,1,1) =', dgncur_a(8,1,1)
!               print*, 'v2ncur_a(8,1,1) =', v2ncur_a(8,1,1)
!               print*, 'dryrad(8,1,1) =', dryrad(8,1,1)
!               print*, 'dryvol(8,1,1) =', dryvol(1)
!               print*, 'h2ommr(8,1) =', h2ommr(8,1)
!               print*, 't(8,1) =', t(8,1)
!               print*, 'pmid(8,1) =', pmid(8,1)
!               print*, 'pdel(8,1) =', pdel(8,1)
!               print*, 'cldn(8,1) =', cldn(8,1) 
!               print*, '=================================================================='
!            endif
!======================== zhh debug 2012-02-08 =======================
         enddo
...
!            if (lchnk == 1155) then
!               print*, 'i =', i, ' k =', k, ' m =', m
!               print*, 'dryrad(i,k,m) =', dryrad(i,k,m)
!            end if
!======================== zhh debug 2012-02-08 =======================
...
!          find smallest real(r8) solution
           ...
           if(nsol.eq.0)then
              ...
              r(i)=rdry(i)
!======================== zhh debug =======================
!             write(iulog,*) 'i =', i, ' im =',im, ' imx =', imx             
!              write(iulog,*) 'rdry(i) =', rdry(i)           
!!              stop
!======================== zhh debug =======================
!             stop
           endif
