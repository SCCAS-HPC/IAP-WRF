...
!----------------------------------------------------------------------
    ...
    subroutine modal_aero_calcsize_sub(                              &
      ...
      use modal_aero_data,  only: numptrcw_amode, mprognum_amode, numptr_amode, qqcw_get_field, lmassptrcw_amode, &
      ...
      !-----------------------------------------------------------------------
!======================== zhh debug 2012-02-08 =======================
!      if (lchnk == 1155) print*, '======= At sub. modal_aero_calcsize_sub ======'
!======================== zhh debug 2012-02-08 =======================
      ...
      do n = 1, ntot_amode
         ...
         do k=1,pver
            do i=1,ncol
               ...
               dryvol_c(i,k) = 0.0_r8
!======================== zhh debug 2012-02-08 =======================
!!               if ( lchnk == 1155 .and. i==7 .and. k==1 .and. n==1 ) then
!!                  print*, '1st: dgncur_a(7,1,1) =', dgncur_a(7,1,1)
!!               end if
!!               if ( lchnk == 1155 .and. i==8 .and. k==1 .and. n==1 ) then
!!                  print*, '1st: dgncur_a(8,1,1) =', dgncur_a(8,1,1)
!!               end if
!======================== zhh debug 2012-02-08 =======================
            end do
         end do
...
!======================== zhh debug 2012-02-08 =======================
!!               if ( lchnk == 1155 .and. i==7 .and. k==1 .and. n==1 ) then
!!                  print*, '1st: i=7, num_a =', num_a
!!               end if
!!               if ( lchnk == 1155 .and. i==8 .and. k==1 .and. n==1 ) then
!!                  print*, '1st: i=8, lna =', lna
!!                  print*, '1st: i=8, num_a =', num_a
!!                  print*, '1st: i=8, q(i,k,lna) =', q(i,k,lna)
!!               end if
!======================== zhh debug 2012-02-08 =======================
...
!======================== zhh debug 2012-02-08 =======================
!!                     if ( lchnk == 1155 .and. i==7 .and. k==1 .and. n==1 ) then
!!                        print*, '2nd: i=7, num_a =', num_a
!!                     end if
!!                     if ( lchnk == 1155 .and. i==8 .and. k==1 .and. n==1 ) then
!!                        print*, '2nd: i=8, num_a =', num_a
!!                     end if
!======================== zhh debug 2012-02-08 =======================
...
!======================== zhh debug 2012-02-08 =======================
!!                     if ( lchnk == 1155 .and. i==7 .and. k==1 .and. n==1 ) then
!!                        print*, '3rd: i=7, num_a =', num_a
!!                     end if
!!                     if ( lchnk == 1155 .and. i==8 .and. k==1 .and. n==1 ) then
!!                        print*, '3rd: i=8, num_a =', num_a
!!                     end if
!======================== zhh debug 2012-02-08 =======================
                  end if
...
!======================== zhh debug 2012-02-08 =======================
!!               if ( lchnk == 1155 .and. i==7 .and. k==1 .and. n==1 ) then
!!                  print*, '2nd: dgncur_a(7,1,1) =', dgncur_a(7,1,1)
!!                  print*, 'num_a =', num_a
!!                  print*, 'drv_a =', drv_a
!!                  print*, 'dgnxx =', dgnxx
!!                  print*, 'dgnyy =', dgnyy
...
!!               end if
!!               if ( lchnk == 1155 .and. i==8 .and. k==1 .and. n==1 ) then
!!                  print*, '2nd: dgncur_a(8,1,1) =', dgncur_a(8,1,1)
!!                  print*, 'num_a =', num_a
!!                  print*, 'drv_a =', drv_a
!!                  print*, 'dgnxx =', dgnxx
!!                  print*, 'dgnyy =', dgnyy
...
!======================== zhh debug 2012-02-08 =======================
!!               if ( lchnk == 1155 .and. i==7 .and. k==1 .and. n==1 ) then
!!                  print*, '3rd: dgncur_a(7,1,1) =', dgncur_a(7,1,1)
!!               end if
!!               if ( lchnk == 1155 .and. i==8 .and. k==1 .and. n==1 ) then
!!                  print*, '3rd: dgncur_a(8,1,1) =', dgncur_a(8,1,1)
!!               end if
!======================== zhh debug 2012-02-08 =======================
