...
!    if ( lchnk==1155 ) then
!       print*, '============= At sub. aerosol_wet_intr ==========='
!!       print*, 'ncol =', ncol
!!       print*, 'dgnum_pbuf(8,1,:) =', dgnum_pbuf(8,1,:)
!!       print*, 'dgnum_pbuf(7,1,:) =', dgnum_pbuf(7,1,:)
!       print*, 'dgnum_pbuf(8,1,1) =', dgnum_pbuf(8,1,1)
!       print*, 'state%t(8,1) =', state%t(8,1)
!       print*, 'state%pmid(8,1) =', state%pmid(8,1)
!       print*, 'state%q(7,1,17) =', state%q(7,1,17)
!       print*, 'state%q(8,1,17) =', state%q(8,1,17)
!       print*, 'state%q(8,1,:) =', state%q(8,1,:)
!    end if
!======================== zhh debug 2012-02-08 =======================
...
!======================== zhh debug 2012-02-08 =======================
!    if ( lchnk==1155 ) then
!       print*, '---------- before calling modal_aero_wateruptake_sub ----------'
!       print*, 'ncol =', ncol
!       print*, 'dgnum_pbuf(7,1,1) =', dgnum_pbuf(7,1,1)
!       print*, 'dgnum_pbuf(8,1,1) =', dgnum_pbuf(8,1,1)
!    end if
!======================== zhh debug 2012-02-08 =======================
