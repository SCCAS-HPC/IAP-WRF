...
!
  ...
  use scanslt,      only: nxptj, platd    !zhh 2008.4.15
  implicit none

!------------------------------Parameters-------------------------------
!!  integer, parameter ::  jfirst = nxpt + 1          ! first index to be computed
!!  integer, parameter ::  jlast  = platd - nxpt - 1  ! last  index to be computed
  integer, parameter ::  jfirst = nxptj + 1          ! first index to be computed
  integer, parameter ::  jlast  = platd - nxptj - 1  ! last  index to be computed
!-----------------------------------------------------------------------
