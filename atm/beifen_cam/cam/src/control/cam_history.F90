...
!  
! Modified: 2013-03-19, Zhang He, added dycore_is('IAP')
! Reviewed: Zhang He, 2013-03-27
!-----------------------------------------------------------------------

   use shr_kind_mod, only: r8 => shr_kind_r8, r4 => shr_kind_r4
   use spmd_utils,   only: masterproc, npes, iam ! juanxiong he
...
!               if (.not. dycore_is('LR') )then                  
               if ((.not. dycore_is('LR')) .and. (.not. dycore_is('IAP')))then                  
...
!
      ...
      case (dyn_decomp)
!         if ( dycore_is('LR') )then
         if ( dycore_is('LR') .or. dycore_is('IAP') )then      !zhh 3013-03-19
            listentry%field%begdim1  = beglonxy
            listentry%field%enddim1  = endlonxy
            listentry%field%begdim2  = 1
            listentry%field%enddim2  = numlev
