subroutine extyvv(pkcnst  ,pkdim   ,coslam  ,sinlam  ,ub      , &
                 vb      )
...
!-----------------------------------------------------------------------
!
! $Id: extyv.F90,v 1.1.2.3 2004/09/23 17:20:08 erik Exp $
! $Author: erik $
!
!-----------------------------------------------------------------------
...
!
  ...
  real(r8), intent(inout):: ub(plond,beglev:endlev,beglatex:endlatex) ! U-wind with extents
  real(r8), intent(inout):: vb(plond,beglev:endlev,beglatex:endlatex) ! V-wind with extents
!
!-----------------------------------------------------------------------
