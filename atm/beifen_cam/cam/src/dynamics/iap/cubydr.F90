...
!
  real(r8), intent(in) :: fint(plon,beglev:endlev,ppdy,pf)   ! constituent x- interpolants
  real(r8), intent(in) :: wdy(4,2,platd)            ! latitude interpolation weights
!
  integer, intent(in) :: jdp(plon,beglev:endlev)         ! indices of latitude intervals
  integer, intent(in) :: jcen                   ! current latitude index
  integer, intent(in) :: nlon
!
! Output arguments
!
  real(r8), intent(out) :: fyb(plon,beglev:endlev,pf)         ! Derivative at south end of interval
  real(r8), intent(out) :: fyt(plon,beglev:endlev,pf)         ! Derivative at north end of interval
!-----------------------------------------------------------------------
!
...
!
  ...
  integer icount,icount1,ierr            ! counter
  integer ii                ! index
