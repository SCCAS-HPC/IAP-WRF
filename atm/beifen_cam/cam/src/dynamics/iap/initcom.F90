...
!                    L. Buja, Feb 1996
!
! Modified: ZhangHe, Wujianping
!           juanxiong He, adapt to CESM
! Reviewed: ZhangHe, 2011-11-18
!           ZhangHe, 2011-12-17, add calling sub. STFRAM
!           ZhangHe, 2011-12-19
!           ZhangHe, 2012-10-30
!-----------------------------------------------------------------------
!
...
!   call hdinti  (rearth  ,zdt   )  !zhang he
...
!
   ...
   if ( .not. single_column ) then
!
! latitude dependent arrays
!
!!zhh      call gauaw(zsi     ,zw      ,plat    )
! Note: gaussian weights w(lat) is calculated in sub. stfram
!
      do irow=1,plat/2  
...
!
!!   zdt = dtime
!zhh 2011-12-17   if (nsrest==0) zdt = 0.5_r8*zdt
!
!zhh 2011-11-18   call settau(zdt)
!
