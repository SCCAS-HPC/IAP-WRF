...
!
   integer, intent(in) :: jdp(plon,beglev:endlev)             ! j-index of coord. of dep. pt.
   integer, intent(in) :: nlon
!
! Input/output arguments
!
   real(r8), intent(inout) :: fyb(plon,beglev:endlev,pf)       ! y-derivatives at bot of interval
   real(r8), intent(inout) :: fyt(plon,beglev:endlev,pf)       ! y-derivatives at top of interval
!
!-----------------------------------------------------------------------
!
...
!
   real(r8) rdy (plon,beglev:endlev)      ! 1./dy
