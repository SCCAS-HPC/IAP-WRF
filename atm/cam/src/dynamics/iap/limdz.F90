...
! Input arguments
!
   real(r8), intent(in) :: f(beglonxy:endlonxy,plev,pcnst)   ! input field
...
!
   real(r8), intent(inout) :: fst(beglonxy:endlonxy,plev,pcnst) ! z-derivative at top of interval
   real(r8), intent(inout) :: fsb(beglonxy:endlonxy,plev,pcnst) ! z-derivative at bot of interval
!
!-----------------------------------------------------------------------
!
...
!
   ...
   real(r8) deli(beglonxy:endlonxy)           ! simple linear derivative
