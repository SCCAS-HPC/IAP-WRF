...
!============================ zhh 2008.7.3 ==========================
   real(r8), public, parameter :: GRAV   = shr_const_g    ! acceleration of gravity   unit : m/s^2
   real(r8), public, parameter :: RAD    = shr_const_rearth    ! radius of earth           unit : m
   real(r8), public, parameter :: b0     = 87.8D0    ! characteristic phase-speed of the inertial-graviational internal wave  unit : m/sec   
!============================ zhh 2008.7.3 ==========================
...
!============================ zhh 2008.7.3 ==========================
   real(r8), public :: RD     = shr_const_rdair   ! Dry air gas constant   unit : J/K/kg
   real(r8), public :: CP     = shr_const_cpdair ! specific heat of dry air  unit : J/kg/K
   real(r8), public :: CAPA   = shr_const_rdair/shr_const_cpdair
!============================ zhh 2008.7.3 ==========================   
