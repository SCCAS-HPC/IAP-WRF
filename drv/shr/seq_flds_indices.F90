...
! drv -> geatm, three dimension 
  ...
  integer, dimension(1:num_cam_levs) :: index_x2ge_Sx_z3d            ! atm level height
  integer, dimension(1:num_cam_levs)  :: index_x2ge_Sx_u3d            ! atm level zon wind
  integer, dimension(1:num_cam_levs)  :: index_x2ge_Sx_v3d            ! atm level mer wind
  integer, dimension(1:num_cam_levs)  :: index_x2ge_Sx_t3d            ! atm level temp
  integer, dimension(1:num_cam_levs)  :: index_x2ge_Sx_qv3d         ! atm level qv
  integer, dimension(1:num_cam_levs)  :: index_x2ge_Sx_qc3d         ! atm level qc
  integer, dimension(1:num_cam_levs)  :: index_x2ge_Sx_qi3d         ! atm level qi
  integer, dimension(1:num_cam_levs)  :: index_x2ge_Sx_p3d          ! atm level pressure 
  integer, dimension(1:num_cam_levs)  :: index_x2ge_Sx_rh3d        ! atm level rh 
  integer, dimension(1:num_cam_levs)  :: index_x2ge_Sx_taucldi3d     ! atm level taucldi
  integer, dimension(1:num_cam_levs)  :: index_x2ge_Sx_taucldv3d     ! atm level taucldc 
  integer :: index_x2ge_Sx_ps         ! atm surface pressure 
  integer :: index_x2ge_Sx_phis         ! atm surface geopotential height
  integer :: index_x2ge_Sx_lat         ! atm latitude
  integer :: index_x2ge_Sx_lon         ! atm longittude
  integer :: index_x2ge_Sx_t2         !surface temperature
  integer :: index_x2ge_Sx_q2         !surface temperature
  integer :: index_x2ge_Sx_rh2         !surface temperature
  integer :: index_x2ge_Sx_ts         !surface temperature
  integer :: index_x2ge_Sx_sst        ! sst   
  integer :: index_x2ge_Sx_snowhland  ! snow height over land  
  integer :: index_x2ge_Sx_snowhice !snow height over ice    
  integer :: index_x2ge_Sx_seaice  ! seaice  
  integer :: index_x2ge_Sx_ocnfrac !ocn fraction          
  integer :: index_x2ge_Sx_u10 ! u10          
  integer :: index_x2ge_Sx_v10 ! v10          
  integer :: index_x2ge_Sx_ust ! ust          
  integer :: index_x2ge_Sx_rmol ! rmol          
  integer :: index_x2ge_Sx_pblh ! pblh          
  integer :: index_x2ge_Sx_raincv ! raincv          
  integer :: index_x2ge_Sx_rainncv ! rainncv          
  integer :: index_x2ge_Sx_swdown !swdown          
  integer :: index_x2ge_Sx_clflo !clflo
  integer :: index_x2ge_Sx_clfmi !clfmi
  integer :: index_x2ge_Sx_clfhi !clfhi
 
  integer, dimension(1:num_soil_layers) :: index_x2ge_Sx_soildepth ! soil layer depth
  integer, dimension(1:num_soil_layers)  :: index_x2ge_Sx_soilthick ! soil layer thickness
  integer, dimension(1:num_soil_layers)  :: index_x2ge_Sx_soilt ! soil layer temperature
  integer, dimension(1:num_soil_layers)  :: index_x2ge_Sx_soilm ! soil layer moisture

  integer :: nflds_x2ge

  ! geatm -> drv
  integer, dimension(1:num_cam_levs,1:num_tracers) :: index_ge2x_Fgexge_tracer      ! for radiation
  integer :: nflds_ge2x
 
  ! drv -> cam, three dimension (flux)
  integer, dimension(1:num_cam_levs,1:num_tracers) :: index_x2ca_Fcaxx_tracer    ! fo radiation 
  integer :: nflds_x2ca
  ...
  integer :: index_ca2x_Sca_rh2 ! rh2          
  ...
  integer :: nflds_ca2x
!-----------------------------------------------------------------------------------------------------------
!    for geatm-cam coupling
!    Juanxiong He, 06/10/2013
!-----------------------------------------------------------------------------------------------------------  

! drv -> wrf, three dimension (nudging)
  ! drv->wrf  
  integer, dimension(1:num_cam_levs) :: index_x2w_Sx_z3d            ! atm level height
  integer, dimension(1:num_cam_levs)  :: index_x2w_Sx_u3d            ! atm level zon wind
  integer, dimension(1:num_cam_levs)  :: index_x2w_Sx_v3d            ! atm level mer wind
  integer, dimension(1:num_cam_levs)  :: index_x2w_Sx_t3d            ! atm level temp
  integer, dimension(1:num_cam_levs)  :: index_x2w_Sx_w3d         ! atm level vert wind
  integer, dimension(1:num_cam_levs)  :: index_x2w_Sx_q3d         ! atm level spec hum
  integer, dimension(1:num_cam_levs)  :: index_x2w_Sx_p3d           ! atm levelpressure 
  integer, dimension(1:num_cam_levs)  :: index_x2w_Fxw_utend         ! atm level u wind tendency
  integer, dimension(1:num_cam_levs)  :: index_x2w_Fxw_vtend         ! atm level v wind tendency
  integer, dimension(1:num_cam_levs)  :: index_x2w_Fxw_ttend           ! atm level t tendency 
  integer, dimension(1:num_cam_levs)  :: index_x2w_Fxw_qtend           ! atm level q tendency 
  integer :: index_x2w_Sx_ps         ! atm surface pressure
  integer :: index_x2w_Sx_phis         ! atm surface geopotential height
  integer :: index_x2w_Sx_lat         ! atm latitude
  integer :: index_x2w_Sx_lon         ! atm longittude
  integer :: index_x2w_Sx_ts         !surface temperature
  integer :: index_x2w_Sx_sst        ! sst   
  integer :: index_x2w_Sx_snowhland  ! snow height over land  
  integer :: index_x2w_Sx_snowhice !snow height over ice    
  integer :: index_x2w_Sx_seaice  ! seaice  
  integer :: index_x2w_Sx_ocnfrac !ocn fraction          
  integer, dimension(1:num_soil_layers) :: index_x2w_Sx_soildepth ! soil layer depth
  integer, dimension(1:num_soil_layers)  :: index_x2w_Sx_soilthick ! soil layer thickness
  integer, dimension(1:num_soil_layers)  :: index_x2w_Sx_soilt ! soil layer temperature
  integer, dimension(1:num_soil_layers)  :: index_x2w_Sx_soilm ! soil layer moisture

  integer :: nflds_x2w

  ! wrf -> drv
        
  integer, dimension(1:num_cam_levs) :: index_w2x_Fwxw_dudt      ! heat from radiation tendency (K/s)
  integer, dimension(1:num_cam_levs) :: index_w2x_Fwxw_dvdt      ! heat from pbl tendency (K/s)
  integer, dimension(1:num_cam_levs) :: index_w2x_Fwxw_dtdt      ! heat from cumulus tendency (K/s)
  integer, dimension(1:num_cam_levs) :: index_w2x_Fwxw_dqdt      ! heat from microphysic tendency (K/s)

  integer, dimension(1:num_cam_levs) :: index_w2x_Sw_q3d            ! atm level q
  integer, dimension(1:num_cam_levs)  :: index_w2x_Sw_u3d            ! atm level zon wind
  integer, dimension(1:num_cam_levs)  :: index_w2x_Sw_v3d            ! atm level mer wind
  integer, dimension(1:num_cam_levs)  :: index_w2x_Sw_t3d            ! atm level temp
  integer :: index_w2x_Sw_ps           ! ps
...
! soildepth/height and soil temperature/moisture for wrf/cam coupling, added juanxiong he 
!-------------------------------------------------------------------------------------- 
  integer, dimension(1:num_soil_layers) :: index_l2x_Sl_soildepth ! soil layer  depth
  integer, dimension(1:num_soil_layers) :: index_l2x_Sl_soilthick ! soil layer  thickness
  integer, dimension(1:num_soil_layers) :: index_l2x_Sl_soilt ! soil layer  temperature
  integer, dimension(1:num_soil_layers) :: index_l2x_Sl_soilm ! soil layer  moisture
!--------------------------------------------------------------------------------------
! soildepth/height and soil temperature/moisture for wrf/cam coupling, added juanxiong he 
!--------------------------------------------------------------------------------------  
  integer :: nflds_l2x
...
!    Juanxiong He, 05/10/2010
!-----------------------------------------------------------------------------------------------------------    
! drv -> geatm, three dimension (scalar)
   do k = 1, num_cam_levs       
    index_x2ge_Sx_z3d(k)          = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_z3d'//clev(k) )
    if (index_x2ge_Sx_z3d(k) == 0) call shr_sys_abort('index_x2ge_Sx_z3d is zero')

    index_x2ge_Sx_u3d(k)          = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_u3d'//clev(k) )
    if (index_x2ge_Sx_u3d(k) == 0) call shr_sys_abort('index_x2ge_Sx_u3d is zero')

    index_x2ge_Sx_v3d(k)          = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_v3d'//clev(k) )
    if (index_x2ge_Sx_v3d(k) == 0) call shr_sys_abort('index_x2ge_Sx_v3d is zero')

    index_x2ge_Sx_t3d(k)          = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_t3d'//clev(k) )
    if (index_x2ge_Sx_t3d(k) == 0) call shr_sys_abort('index_x2ge_Sx_t3d is zero')

    index_x2ge_Sx_rh3d(k)          = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_rh3d'//clev(k) )
    if (index_x2ge_Sx_rh3d(k) == 0) call shr_sys_abort('index_x2ge_Sx_rh3d is zero')

    index_x2ge_Sx_qv3d(k)          = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_qv3d'//clev(k) )
    if (index_x2ge_Sx_qv3d(k) == 0) call shr_sys_abort('index_x2ge_Sx_qv3d is zero')

    index_x2ge_Sx_qi3d(k)          = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_qi3d'//clev(k) )
    if (index_x2ge_Sx_qi3d(k) == 0) call shr_sys_abort('index_x2ge_Sx_qi3d is zero')

    index_x2ge_Sx_qc3d(k)          = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_qc3d'//clev(k) )
    if (index_x2ge_Sx_qc3d(k) == 0) call shr_sys_abort('index_x2ge_Sx_qc3d is zero')

    index_x2ge_Sx_p3d(k)          = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_p3d'//clev(k) )
    if (index_x2ge_Sx_p3d(k) == 0) call shr_sys_abort('index_x2ge_Sx_p3d is zero')

    index_x2ge_Sx_taucldi3d(k)          = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_taucldi3d'//clev(k) )
    if (index_x2ge_Sx_taucldi3d(k) == 0) call shr_sys_abort('index_x2ge_Sx_taucldi3d is zero')

    index_x2ge_Sx_taucldv3d(k)          = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_taucldv3d'//clev(k) )
    if (index_x2ge_Sx_taucldv3d(k) == 0) call shr_sys_abort('index_x2ge_Sx_taucldv3d is zero')
   end do

    index_x2ge_Sx_ps        = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_ps')
    if (index_x2ge_Sx_ps == 0) call shr_sys_abort('index_x2ge_Sx_ps is zero')

    index_x2ge_Sx_phis        = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_phis')
    if (index_x2ge_Sx_phis == 0) call shr_sys_abort('index_x2ge_Sx_phis is zero')

    index_x2ge_Sx_lat       = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_lat')
    if (index_x2ge_Sx_lat == 0) call shr_sys_abort('index_x2ge_Sx_lat is zero')

    index_x2ge_Sx_lon        = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_lon')
    if (index_x2ge_Sx_lon == 0) call shr_sys_abort('index_x2ge_Sx_lon is zero')

    index_x2ge_Sx_ts        = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_ts')
    if (index_x2ge_Sx_ts == 0) call shr_sys_abort('index_x2ge_Sx_ts is zero')

    index_x2ge_Sx_sst        = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_sst')
    if (index_x2ge_Sx_sst == 0) call shr_sys_abort('index_x2ge_Sx_sst is zero')

    index_x2ge_Sx_snowhland  = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_snowhland')
    if (index_x2ge_Sx_snowhland == 0) call shr_sys_abort('index_x2ge_Sx_snowhland is zero')

    index_x2ge_Sx_snowhice  = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_snowhice') 
    if (index_x2ge_Sx_snowhice == 0) call shr_sys_abort('index_x2ge_Sx_snowhice is zero')

    index_x2ge_Sx_seaice  = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_seaice')
    if (index_x2ge_Sx_seaice == 0) call shr_sys_abort('index_x2ge_Sx_seaice is zero')

    index_x2ge_Sx_ocnfrac  = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_ocnfrac')
    if (index_x2ge_Sx_ocnfrac == 0) call shr_sys_abort('index_x2ge_Sx_ocnfrac is zero')

    index_x2ge_Sx_t2  = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_t2')
    if (index_x2ge_Sx_t2 == 0) call shr_sys_abort('index_x2ge_Sx_t2 is zero')

    index_x2ge_Sx_q2  = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_q2')
    if (index_x2ge_Sx_q2 == 0) call shr_sys_abort('index_x2ge_Sx_q2 is zero')

    index_x2ge_Sx_rh2  = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_rh2')
    if (index_x2ge_Sx_rh2 == 0) call shr_sys_abort('index_x2ge_Sx_rh2 is zero')

    index_x2ge_Sx_u10  = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_u10')
    if (index_x2ge_Sx_u10 == 0) call shr_sys_abort('index_x2ge_Sx_u10 is zero')

    index_x2ge_Sx_v10  = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_v10')
    if (index_x2ge_Sx_v10 == 0) call shr_sys_abort('index_x2ge_Sx_v10 is zero')

    index_x2ge_Sx_ust  = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_ust')
    if (index_x2ge_Sx_ust == 0) call shr_sys_abort('index_x2ge_Sx_ust is zero')

    index_x2ge_Sx_rmol  = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_rmol')
    if (index_x2ge_Sx_rmol == 0) call shr_sys_abort('index_x2ge_Sx_rmol is zero')

    index_x2ge_Sx_pblh  = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_pblh')
    if (index_x2ge_Sx_pblh == 0) call shr_sys_abort('index_x2ge_Sx_pblh is zero')

    index_x2ge_Sx_raincv  = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_raincv')
    if (index_x2ge_Sx_raincv == 0) call shr_sys_abort('index_x2ge_Sx_raincv is zero')

    index_x2ge_Sx_rainncv  = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_rainncv')
    if (index_x2ge_Sx_rainncv == 0) call shr_sys_abort('index_x2ge_Sx_rainncv is zero')

    index_x2ge_Sx_swdown  = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_swdown')
    if (index_x2ge_Sx_swdown == 0) call shr_sys_abort('index_x2ge_Sx_swdown is zero')

    index_x2ge_Sx_clflo  = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_clflo')
    if (index_x2ge_Sx_clflo == 0) call shr_sys_abort('index_x2ge_Sx_clflo is zero')

    index_x2ge_Sx_clfmi  = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_clfmi')
    if (index_x2ge_Sx_clfmi == 0) call shr_sys_abort('index_x2ge_Sx_clfmi is zero')

    index_x2ge_Sx_clfhi  = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_clfhi')
    if (index_x2ge_Sx_clfhi == 0) call shr_sys_abort('index_x2ge_Sx_clfhi is zero')

    do k = 1, num_soil_layers
    index_x2ge_Sx_soildepth(k)   = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_soildepth'//slayer(k) )
    if (index_x2ge_Sx_soildepth(k) == 0) call shr_sys_abort('index_x2ge_Sx_soildepth is zero')

    index_x2ge_Sx_soilthick(k)   = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_soilthick'//slayer(k) )
    if (index_x2ge_Sx_soilthick(k) == 0) call shr_sys_abort('index_x2ge_Sx_soilthick is zero')

    index_x2ge_Sx_soilt(k)   = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_soilt'//slayer(k) )
    if (index_x2ge_Sx_soilt(k) == 0) call shr_sys_abort('index_x2ge_Sx_soilt is zero')

    index_x2ge_Sx_soilm(k)   = shr_string_listGetIndexF(seq_flds_x2ge_fields,'Sx_soilm'//slayer(k) )
    if (index_x2ge_Sx_soilm(k) == 0) call shr_sys_abort('index_x2ge_Sx_soilm is zero')
    end do

    nflds_x2ge = shr_string_listGetNum(seq_flds_x2ge_fields)

  ! geatm -> drv, three dimension (flux)

    do k = 1, num_cam_levs
    do i= 1, num_tracers
    index_ge2x_Fgexge_tracer(k,i)       = shr_string_listGetIndexF(seq_flds_ge2x_fields,'Fgexge_tracer'//clev(k)//ctracer(i))
    if (index_ge2x_Fgexge_tracer(k,i) == 0) call shr_sys_abort('index_ge2x_Fgexge_tracer is zero')
    enddo
    enddo

    nflds_ge2x = shr_string_listGetNum(seq_flds_ge2x_fields)      

  ! cam -> drv, three dimension (flux)
    do k = 1, num_cam_levs      
    index_ca2x_Sca_z3d(k)          = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_z3d'//clev(k) )
    if (index_ca2x_Sca_z3d(k) == 0) call shr_sys_abort('index_ca2x_Sca_z3d is zero')

    index_ca2x_Sca_u3d(k)          = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_u3d'//clev(k) )
    if (index_ca2x_Sca_u3d(k) == 0) call shr_sys_abort('index_ca2x_Sca_u3d is zero')

    index_ca2x_Sca_v3d(k)          = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_v3d'//clev(k) )
    if (index_ca2x_Sca_v3d(k) == 0) call shr_sys_abort('index_ca2x_Sca_v3d is zero')

    index_ca2x_Sca_t3d(k)          = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_t3d'//clev(k) )
    if (index_ca2x_Sca_t3d(k) == 0) call shr_sys_abort('index_ca2x_Sca_t3d is zero')

    index_ca2x_Sca_rh3d(k)          = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_rh3d'//clev(k) )
    if (index_ca2x_Sca_rh3d(k) == 0) call shr_sys_abort('index_ca2x_Sca_rh3d is zero')

    index_ca2x_Sca_qv3d(k)          = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_qv3d'//clev(k) )
    if (index_ca2x_Sca_qv3d(k) == 0) call shr_sys_abort('index_ca2x_Sca_qv3d is zero')

    index_ca2x_Sca_qi3d(k)          = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_qi3d'//clev(k) )
    if (index_ca2x_Sca_qi3d(k) == 0) call shr_sys_abort('index_ca2x_Sca_qi3d is zero')

    index_ca2x_Sca_qc3d(k)          = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_qc3d'//clev(k) )
    if (index_ca2x_Sca_qc3d(k) == 0) call shr_sys_abort('index_ca2x_Sca_qc3d is zero')

    index_ca2x_Sca_p3d(k)          = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_p3d'//clev(k) )
    if (index_ca2x_Sca_p3d(k) == 0) call shr_sys_abort('index_ca2x_Sca_p3d is zero')

    index_ca2x_Sca_taucldi3d(k)          = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_taucldi3d'//clev(k) )
    if (index_ca2x_Sca_taucldi3d(k) == 0) call shr_sys_abort('index_ca2x_Sca_taucldi3d is zero')

    index_ca2x_Sca_taucldv3d(k)          = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_taucldv3d'//clev(k) )
    if (index_ca2x_Sca_taucldv3d(k) == 0) call shr_sys_abort('index_ca2x_Sca_taucldv3d is zero')
    enddo

    index_ca2x_Sca_ps        =  shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_ps')
    if (index_ca2x_Sca_ps == 0) call shr_sys_abort('index_ca2x_Sca_ps is zero')

    index_ca2x_Sca_phis        =  shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_phis')
    if (index_ca2x_Sca_phis == 0) call shr_sys_abort('index_ca2x_Sca_phis is zero') 

    index_ca2x_Sca_lat       = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_lat')
    if (index_ca2x_Sca_lat == 0) call shr_sys_abort('index_ca2x_Sca_lat is zero')

    index_ca2x_Sca_lon       = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_lon')
    if (index_ca2x_Sca_lon == 0) call shr_sys_abort('index_ca2x_Sca_lon is zero')

    index_ca2x_Sca_ts        = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_ts')
    if (index_ca2x_Sca_ts == 0) call shr_sys_abort('index_ca2x_Sca_ts is zero')

    index_ca2x_Sca_sst        = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_sst')
    if (index_ca2x_Sca_sst == 0) call shr_sys_abort('index_ca2x_Sca_sst is zero')
 
    index_ca2x_Sca_snowhland  = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_snowhland')
    if (index_ca2x_Sca_snowhland == 0) call shr_sys_abort('index_ca2x_Sca_snowhland is zero')

    index_ca2x_Sca_snowhice  = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_snowhice')
    if (index_ca2x_Sca_snowhice == 0) call shr_sys_abort('index_ca2x_Sca_snowhice is zero') 

    index_ca2x_Sca_seaice  = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_seaice')
    if (index_ca2x_Sca_seaice == 0) call shr_sys_abort('index_ca2x_Sca_seaice is zero')

    index_ca2x_Sca_ocnfrac  = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_ocnfrac')
    if (index_ca2x_Sca_ocnfrac == 0) call shr_sys_abort('index_ca2x_Sca_ocnfrac is zero')

    index_ca2x_Sca_t2  = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_t2')
    if (index_ca2x_Sca_t2 == 0) call shr_sys_abort('index_ca2x_Sca_t2 is zero')

    index_ca2x_Sca_q2  = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_q2')
    if (index_ca2x_Sca_q2 == 0) call shr_sys_abort('index_ca2x_Sca_q2 is zero')

    index_ca2x_Sca_rh2  = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_rh2')
    if (index_ca2x_Sca_rh2 == 0) call shr_sys_abort('index_ca2x_Sca_rh2 is zero')

    index_ca2x_Sca_u10  = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_u10')
    if (index_ca2x_Sca_u10 == 0) call shr_sys_abort('index_ca2x_Sca_u10 is zero')

    index_ca2x_Sca_v10  = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_v10')
    if (index_ca2x_Sca_v10 == 0) call shr_sys_abort('index_ca2x_Sca_v10 is zero')

    index_ca2x_Sca_ust  = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_ust')
    if (index_ca2x_Sca_ust == 0) call shr_sys_abort('index_ca2x_Sca_ust is zero')

    index_ca2x_Sca_rmol  = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_rmol')
    if (index_ca2x_Sca_rmol == 0) call shr_sys_abort('index_ca2x_Sca_rmol is zero')

    index_ca2x_Sca_pblh  = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_pblh')
    if (index_ca2x_Sca_pblh == 0) call shr_sys_abort('index_ca2x_Sca_pblh is zero')

    index_ca2x_Sca_raincv  = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_raincv')
    if (index_ca2x_Sca_raincv == 0) call shr_sys_abort('index_ca2x_Sca_raincv is zero')

    index_ca2x_Sca_rainncv  = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_rainncv')
    if (index_ca2x_Sca_rainncv == 0) call shr_sys_abort('index_ca2x_Sca_rainncv is zero')

    index_ca2x_Sca_swdown  = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_swdown')
    if (index_ca2x_Sca_swdown == 0) call shr_sys_abort('index_ca2x_Sca_swdown is zero')

    index_ca2x_Sca_clflo  = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_clflo')
    if (index_ca2x_Sca_clflo == 0) call shr_sys_abort('index_ca2x_Sca_clflo is zero')

    index_ca2x_Sca_clfmi  = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_clfmi')
    if (index_ca2x_Sca_clfmi == 0) call shr_sys_abort('index_ca2x_Sca_clfmi is zero')
    
    index_ca2x_Sca_clfhi  = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_clfhi')
    if (index_ca2x_Sca_clfhi == 0) call shr_sys_abort('index_ca2x_Sca_clfhi is zero')

    do k = 1, num_soil_layers
    index_ca2x_Sca_soildepth(k)   = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_soildepth'//slayer(k) )
    if (index_ca2x_Sca_soildepth(k) == 0) call shr_sys_abort('index_ca2x_Sca_soildepth is zero')

    index_ca2x_Sca_soilthick(k)   = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_soilthick'//slayer(k) )
    if (index_ca2x_Sca_soilthick(k) == 0) call shr_sys_abort('index_ca2x_Sca_soilthick is zero')

    index_ca2x_Sca_soilt(k)   = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_soilt'//slayer(k) )
    if (index_ca2x_Sca_soilt(k) == 0) call shr_sys_abort('index_ca2x_Sca_soilt is zero')

    index_ca2x_Sca_soilm(k)   = shr_string_listGetIndexF(seq_flds_ca2x_fields,'Sca_soilm'//slayer(k) )
    if (index_ca2x_Sca_soilm(k) == 0) call shr_sys_abort('index_ca2x_Sca_soilm is zero')
    end do

    nflds_ca2x = shr_string_listGetNum(seq_flds_ca2x_fields)

  ! drv -> cam, three dimension (scalar)
    do k = 1, num_cam_levs
    do i=1, num_tracers
    index_x2ca_Fcaxx_tracer(k,i)          = shr_string_listGetIndexF(seq_flds_x2ca_fields,'Fcaxx_tracer'//clev(k)//ctracer(i))
    if (index_x2ca_Fcaxx_tracer(k,i) == 0) call shr_sys_abort('index_x2ca_Fcaxx_tracer is zero')
    end do
    end do

    nflds_x2ca = shr_string_listGetNum(seq_flds_x2ca_fields)
!-----------------------------------------------------------------------------------------------------------
!    forg eatm-cam coupling
!    Juanxiong He, 06/10/2013
!-----------------------------------------------------------------------------------------------------------   

! drv -> wrf, three dimension (scalar)
   do k = 1, num_cam_levs       
    index_x2w_Sx_z3d(k)          = shr_string_listGetIndexF(seq_flds_x2w_fields,'Sx_z3d'//clev(k) )
    if (index_x2w_Sx_z3d(k) == 0) call shr_sys_abort('index_x2w_Sx_z3d is zero')

    index_x2w_Sx_u3d(k)          = shr_string_listGetIndexF(seq_flds_x2w_fields,'Sx_u3d'//clev(k) )
    if (index_x2w_Sx_u3d(k) == 0) call shr_sys_abort('index_x2w_Sx_u3d is zero')

    index_x2w_Sx_v3d(k)       = shr_string_listGetIndexF(seq_flds_x2w_fields,'Sx_v3d'//clev(k) )
    if (index_x2w_Sx_v3d(k) == 0) call shr_sys_abort('index_x2w_Sx_v3d is zero')

    index_x2w_Sx_t3d(k)         = shr_string_listGetIndexF(seq_flds_x2w_fields,'Sx_t3d'//clev(k) )
    if (index_x2w_Sx_t3d(k) == 0) call shr_sys_abort('index_x2w_Sx_t3d is zero')

    index_x2w_Sx_w3d(k)        = shr_string_listGetIndexF(seq_flds_x2w_fields,'Sx_w3d'//clev(k) )
    if (index_x2w_Sx_w3d(k) == 0) call shr_sys_abort('index_x2w_Sx_w3d is zero')

    index_x2w_Sx_q3d(k)          = shr_string_listGetIndexF(seq_flds_x2w_fields,'Sx_q3d'//clev(k) )
    if (index_x2w_Sx_q3d(k) == 0) call shr_sys_abort('index_x2w_Sx_q3d is zero')

    index_x2w_Sx_p3d(k)         = shr_string_listGetIndexF(seq_flds_x2w_fields,'Sx_p3d'//clev(k) )
    if (index_x2w_Sx_p3d(k) == 0) call shr_sys_abort('index_x2w_Sx_p3d is zero')

    index_x2w_Fxw_utend(k)        = shr_string_listGetIndexF(seq_flds_x2w_fields,'Fxw_utend'//clev(k) )
    if (index_x2w_Fxw_utend(k) == 0) call shr_sys_abort('index_x2w_Fxw_utend is zero')

    index_x2w_Fxw_vtend(k)          = shr_string_listGetIndexF(seq_flds_x2w_fields,'Fxw_vtend'//clev(k) )
    if (index_x2w_Fxw_vtend(k) == 0) call shr_sys_abort('index_x2w_Fxw_vtend is zero')

    index_x2w_Fxw_ttend(k)         = shr_string_listGetIndexF(seq_flds_x2w_fields,'Fxw_ttend'//clev(k) )
    if (index_x2w_Fxw_ttend(k) == 0) call shr_sys_abort('index_x2w_Fxw_ttend is zero')

    index_x2w_Fxw_qtend(k)         = shr_string_listGetIndexF(seq_flds_x2w_fields,'Fxw_qtend'//clev(k) )
    if (index_x2w_Fxw_qtend(k) == 0) call shr_sys_abort('index_x2w_Fxw_qtend is zero')
   end do

    index_x2w_Sx_ps        = shr_string_listGetIndexF(seq_flds_x2w_fields,'Sx_ps')
    if (index_x2w_Sx_ps == 0) call shr_sys_abort('index_x2w_Sx_ps is zero')

    index_x2w_Sx_phis        = shr_string_listGetIndexF(seq_flds_x2w_fields,'Sx_phis')
    if (index_x2w_Sx_phis == 0) call shr_sys_abort('index_x2w_Sx_phis is zero')

    index_x2w_Sx_lat       = shr_string_listGetIndexF(seq_flds_x2w_fields,'Sx_lat')
    if (index_x2w_Sx_lat == 0) call shr_sys_abort('index_x2w_Sx_lat is zero')

    index_x2w_Sx_lon        = shr_string_listGetIndexF(seq_flds_x2w_fields,'Sx_lon')
    if (index_x2w_Sx_lon == 0) call shr_sys_abort('index_x2w_Sx_lon is zero')

    index_x2w_Sx_ts        = shr_string_listGetIndexF(seq_flds_x2w_fields,'Sx_ts')
    if (index_x2w_Sx_ts == 0) call shr_sys_abort('index_x2w_Sx_ts is zero')

    index_x2w_Sx_sst        = shr_string_listGetIndexF(seq_flds_x2w_fields,'Sx_sst')
    if (index_x2w_Sx_sst == 0) call shr_sys_abort('index_x2w_Sx_sst is zero')

    index_x2w_Sx_snowhland  = shr_string_listGetIndexF(seq_flds_x2w_fields,'Sx_snowhland')
    if (index_x2w_Sx_snowhland == 0) call shr_sys_abort('index_x2w_Sx_snowhland is zero')

    index_x2w_Sx_snowhice  = shr_string_listGetIndexF(seq_flds_x2w_fields,'Sx_snowhice')
    if (index_x2w_Sx_snowhice == 0) call shr_sys_abort('index_x2w_Sx_snowhice is zero')

    index_x2w_Sx_seaice  = shr_string_listGetIndexF(seq_flds_x2w_fields,'Sx_seaice')
    if (index_x2w_Sx_seaice == 0) call shr_sys_abort('index_x2w_Sx_seaice is zero')

    index_x2w_Sx_ocnfrac  = shr_string_listGetIndexF(seq_flds_x2w_fields,'Sx_ocnfrac')
    if (index_x2w_Sx_ocnfrac == 0) call shr_sys_abort('index_x2w_Sx_ocnfrac is zero')

    do k = 1, num_soil_layers
    index_x2w_Sx_soildepth(k)   = shr_string_listGetIndexF(seq_flds_x2w_fields,'Sx_soildepth'//slayer(k) )
    if (index_x2w_Sx_soildepth(k) == 0) call shr_sys_abort('index_x2w_Sx_soildepth is zero')

    index_x2w_Sx_soilthick(k)   = shr_string_listGetIndexF(seq_flds_x2w_fields,'Sx_soilthick'//slayer(k) )
    if (index_x2w_Sx_soilthick(k) == 0) call shr_sys_abort('index_x2w_Sx_soilthick is zero')

    index_x2w_Sx_soilt(k)   = shr_string_listGetIndexF(seq_flds_x2w_fields,'Sx_soilt'//slayer(k) )
    if (index_x2w_Sx_soilt(k) == 0) call shr_sys_abort('index_x2w_Sx_soilt is zero')

    index_x2w_Sx_soilm(k)   = shr_string_listGetIndexF(seq_flds_x2w_fields,'Sx_soilm'//slayer(k) )
    if (index_x2w_Sx_soilm(k) == 0) call shr_sys_abort('index_x2w_Sx_soilm is zero')
    end do

    nflds_x2w = shr_string_listGetNum(seq_flds_x2w_fields)

  ! wrf -> drv, three dimension (flux)

    do k = 1, num_cam_levs
    index_w2x_Fwxw_dudt(k)       = shr_string_listGetIndexF(seq_flds_w2x_fields,'Fwxw_dudt'//clev(k))
    if (index_w2x_Fwxw_dudt(k) == 0) call shr_sys_abort('index_w2x_Fwxw_dudt is zero')
        
    index_w2x_Fwxw_dvdt(k)       = shr_string_listGetIndexF(seq_flds_w2x_fields,'Fwxw_dvdt'//clev(k))
    if (index_w2x_Fwxw_dvdt(k) == 0) call shr_sys_abort('index_w2x_Fwxw_dvdt is zero')

    index_w2x_Fwxw_dtdt(k)      = shr_string_listGetIndexF(seq_flds_w2x_fields,'Fwxw_dtdt'//clev(k))
    if (index_w2x_Fwxw_dtdt(k) == 0) call shr_sys_abort('index_w2x_Fwxw_dtdt is zero')

    index_w2x_Fwxw_dqdt(k)      = shr_string_listGetIndexF(seq_flds_w2x_fields,'Fwxw_dqdt'//clev(k))
    if (index_w2x_Fwxw_dqdt(k) == 0) call shr_sys_abort('index_w2x_Fwxw_dqdt is zero')

    index_w2x_Sw_u3d(k)      = shr_string_listGetIndexF(seq_flds_w2x_fields,'Sw_u3d'//clev(k))
    if (index_w2x_Sw_u3d(k) == 0) call shr_sys_abort('index_w2x_Sw_u3d is zero')

    index_w2x_Sw_v3d(k)      = shr_string_listGetIndexF(seq_flds_w2x_fields,'Sw_v3d'//clev(k))
    if (index_w2x_Sw_v3d(k) == 0) call shr_sys_abort('index_w2x_Sw_v3d is zero')

    index_w2x_Sw_t3d(k)      = shr_string_listGetIndexF(seq_flds_w2x_fields,'Sw_t3d'//clev(k))
    if (index_w2x_Sw_t3d(k) == 0) call shr_sys_abort('index_w2x_Sw_t3d is zero')

    index_w2x_Sw_q3d(k)      = shr_string_listGetIndexF(seq_flds_w2x_fields,'Sw_q3d'//clev(k))
    if (index_w2x_Sw_q3d(k) == 0) call shr_sys_abort('index_w2x_Sw_q3d is zero')
    enddo

    index_w2x_Sw_ps      = shr_string_listGetIndexF(seq_flds_w2x_fields,'Sw_ps')
    if (index_w2x_Sw_ps == 0) call shr_sys_abort('index_w2x_Sw_ps is zero')

    nflds_w2x = shr_string_listGetNum(seq_flds_w2x_fields)      

  ! drv -> cam, three dimension (flux)
    do k = 1, num_cam_levs      
    index_x2c_Fcxx_dudt(k)     = shr_string_listGetIndexF(seq_flds_x2c_fields,'Fcxx_dudt'//clev(k))
    if (index_x2c_Fcxx_dudt(k) == 0) call shr_sys_abort('index_x2c_Fcxx_dudt is zero')
        
    index_x2c_Fcxx_dvdt(k)      = shr_string_listGetIndexF(seq_flds_x2c_fields,'Fcxx_dvdt'//clev(k))
    if (index_x2c_Fcxx_dvdt(k) == 0) call shr_sys_abort('index_w2x_Fcxx_dvdt is zero')

    index_x2c_Fcxx_dtdt(k)      = shr_string_listGetIndexF(seq_flds_x2c_fields,'Fcxx_dtdt'//clev(k))
    if (index_x2c_Fcxx_dtdt(k) == 0) call shr_sys_abort('index_w2x_Fcxx_dtdt is zero')

    index_x2c_Fcxx_dqdt(k)     = shr_string_listGetIndexF(seq_flds_x2c_fields,'Fcxx_dqdt'//clev(k))
    if (index_x2c_Fcxx_dqdt(k) == 0) call shr_sys_abort('index_w2x_Fcxx_dqdt is zero')

    index_x2c_Sx_u3d(k)      = shr_string_listGetIndexF(seq_flds_x2c_fields,'Sx_u3d'//clev(k))
    if (index_x2c_Sx_u3d(k) == 0) call shr_sys_abort('index_x2c_Sx_u3d is zero')

    index_x2c_Sx_v3d(k)      = shr_string_listGetIndexF(seq_flds_x2c_fields,'Sx_v3d'//clev(k))
    if (index_x2c_Sx_v3d(k) == 0) call shr_sys_abort('index_x2c_Sx_v3d is zero')

    index_x2c_Sx_t3d(k)      = shr_string_listGetIndexF(seq_flds_x2c_fields,'Sx_t3d'//clev(k))
    if (index_x2c_Sx_t3d(k) == 0) call shr_sys_abort('index_x2c_Sx_t3d is zero')

    index_x2c_Sx_q3d(k)      = shr_string_listGetIndexF(seq_flds_x2c_fields,'Sx_q3d'//clev(k))
    if (index_x2c_Sx_q3d(k) == 0) call shr_sys_abort('index_x2c_Sx_q3d is zero')
    enddo

    index_x2c_Sx_ps      = shr_string_listGetIndexF(seq_flds_x2c_fields,'Sx_ps')
    if (index_x2c_Sx_ps == 0) call shr_sys_abort('index_x2c_Sx_ps is zero')
        
    nflds_x2c = shr_string_listGetNum(seq_flds_x2c_fields)

  ! cam -> drv, three dimension (scalar)
    do k = 1, num_cam_levs
    index_c2x_Sc_z3d(k)          = shr_string_listGetIndexF(seq_flds_c2x_fields,'Sc_z3d'//clev(k) )
    if (index_c2x_Sc_z3d(k) == 0) call shr_sys_abort('index_c2x_Sc_z3d is zero')

    index_c2x_Sc_u3d(k)          = shr_string_listGetIndexF(seq_flds_c2x_fields,'Sc_u3d'//clev(k) )
    if (index_c2x_Sc_u3d(k) == 0) call shr_sys_abort('index_c2x_Sc_u3d is zero')

    index_c2x_Sc_v3d(k)       = shr_string_listGetIndexF(seq_flds_c2x_fields,'Sc_v3d'//clev(k) )
    if (index_c2x_Sc_v3d(k) == 0) call shr_sys_abort('index_c2x_Sc_v3d is zero')

    index_c2x_Sc_t3d(k)         = shr_string_listGetIndexF(seq_flds_c2x_fields,'Sc_t3d'//clev(k) )
    if (index_c2x_Sc_t3d(k) == 0) call shr_sys_abort('index_c2x_Sc_t3d is zero')

    index_c2x_Sc_w3d(k)        = shr_string_listGetIndexF(seq_flds_c2x_fields,'Sc_w3d'//clev(k) )
    if (index_c2x_Sc_w3d(k) == 0) call shr_sys_abort('index_c2x_Sc_w3d is zero')

    index_c2x_Sc_q3d(k)          = shr_string_listGetIndexF(seq_flds_c2x_fields,'Sc_q3d'//clev(k) )
    if (index_c2x_Sc_q3d(k) == 0) call shr_sys_abort('index_c2x_Sc_q3d is zero')

    index_c2x_Sc_p3d(k)          = shr_string_listGetIndexF(seq_flds_c2x_fields,'Sc_p3d'//clev(k) )
    if (index_c2x_Sc_p3d(k) == 0) call shr_sys_abort('index_c2x_Sc_p3d is zero')

    index_c2x_Fcxc_utend(k)          = shr_string_listGetIndexF(seq_flds_c2x_fields,'Fcxc_utend'//clev(k) )
    if (index_c2x_Fcxc_utend(k) == 0) call shr_sys_abort('index_c2x_Fcxc_utend is zero')

    index_c2x_Fcxc_vtend(k)          = shr_string_listGetIndexF(seq_flds_c2x_fields,'Fcxc_vtend'//clev(k) )
    if (index_c2x_Fcxc_vtend(k) == 0) call shr_sys_abort('index_c2x_Fcxc_vtend is zero')

    index_c2x_Fcxc_ttend(k)          = shr_string_listGetIndexF(seq_flds_c2x_fields,'Fcxc_ttend'//clev(k) )
    if (index_c2x_Fcxc_ttend(k) == 0) call shr_sys_abort('index_c2x_Fcxc_ttend is zero')

    index_c2x_Fcxc_qtend(k)          = shr_string_listGetIndexF(seq_flds_c2x_fields,'Fcxc_qtend'//clev(k) )
    if (index_c2x_Fcxc_qtend(k) == 0) call shr_sys_abort('index_c2x_Fcxc_qtend is zero')
    end do

    index_c2x_Sc_ps        = shr_string_listGetIndexF(seq_flds_c2x_fields,'Sc_ps')
    if (index_c2x_Sc_ps == 0) call shr_sys_abort('index_c2x_Sc_ps is zero')

    index_c2x_Sc_phis        = shr_string_listGetIndexF(seq_flds_c2x_fields,'Sc_phis')
    if (index_c2x_Sc_phis == 0) call shr_sys_abort('index_c2x_Sc_phis is zero')

    index_c2x_Sc_lat        = shr_string_listGetIndexF(seq_flds_c2x_fields,'Sc_lat')
    if (index_c2x_Sc_lat == 0) call shr_sys_abort('index_c2x_Sc_lat is zero')

    index_c2x_Sc_lon        = shr_string_listGetIndexF(seq_flds_c2x_fields,'Sc_lon')
    if (index_c2x_Sc_lon == 0) call shr_sys_abort('index_c2x_Sc_lon is zero')

    index_c2x_Sc_ts        = shr_string_listGetIndexF(seq_flds_c2x_fields,'Sc_ts')
    if (index_c2x_Sc_ts == 0) call shr_sys_abort('index_c2x_Sc_ts is zero')

    index_c2x_Sc_sst        = shr_string_listGetIndexF(seq_flds_c2x_fields,'Sc_sst')
    if (index_c2x_Sc_sst == 0) call shr_sys_abort('index_c2x_Sc_sst is zero')

    index_c2x_Sc_snowhland  = shr_string_listGetIndexF(seq_flds_c2x_fields,'Sc_snowhland')
    if (index_c2x_Sc_snowhland == 0) call shr_sys_abort('index_c2x_Sc_snowhland is zero')

    index_c2x_Sc_snowhice  = shr_string_listGetIndexF(seq_flds_c2x_fields,'Sc_snowhice')
    if (index_c2x_Sc_snowhice == 0) call shr_sys_abort('index_c2x_Sc_snowhice is zero')

    index_c2x_Sc_seaice  = shr_string_listGetIndexF(seq_flds_c2x_fields,'Sc_seaice')
    if (index_c2x_Sc_seaice == 0) call shr_sys_abort('index_c2x_Sc_seaice is zero')

    index_c2x_Sc_ocnfrac  = shr_string_listGetIndexF(seq_flds_c2x_fields,'Sc_ocnfrac')
    if (index_c2x_Sc_ocnfrac == 0) call shr_sys_abort('index_c2x_Sc_ocnfrac is zero')

    do k = 1, num_soil_layers
    index_c2x_Sc_soildepth(k)   = shr_string_listGetIndexF(seq_flds_c2x_fields,'Sc_soildepth'//slayer(k) )
    if (index_c2x_Sc_soildepth(k) == 0) call shr_sys_abort('index_c2x_Sc_soildepth is zero')

    index_c2x_Sc_soilthick(k)   = shr_string_listGetIndexF(seq_flds_c2x_fields,'Sc_soilthick'//slayer(k) )
    if (index_c2x_Sc_soilthick(k) == 0) call shr_sys_abort('index_c2x_Sc_soilthick is zero')

    index_c2x_Sc_soilt(k)   = shr_string_listGetIndexF(seq_flds_c2x_fields,'Sc_soilt'//slayer(k) )
    if (index_c2x_Sc_soilt(k) == 0) call shr_sys_abort('index_c2x_Sc_soilt is zero')

    index_c2x_Sc_soilm(k)   = shr_string_listGetIndexF(seq_flds_c2x_fields,'Sc_soilm'//slayer(k) )
    if (index_c2x_Sc_soilm(k) == 0) call shr_sys_abort('index_c2x_Sc_soilm is zero')
    end do

    nflds_c2x = shr_string_listGetNum(seq_flds_c2x_fields)
!-----------------------------------------------------------------------------------------------------------
!    for wrf-cam coupling
!    Juanxiong He, 05/10/2010
!-----------------------------------------------------------------------------------------------------------   
...
!-------------------------------------------------------------------------------------- 
    do k = 1 ,num_soil_layers
    index_x2a_Sx_soildepth(k)   = shr_string_listGetIndexF(seq_flds_x2a_fields,'Sx_soildepth'//slayer(k) )
    if (index_x2a_Sx_soildepth(k) == 0) call shr_sys_abort('index_x2a_Sx_soildepth is zero')
    
    index_x2a_Sx_soilthick(k)   = shr_string_listGetIndexF(seq_flds_x2a_fields,'Sx_soilthick'//slayer(k) )
    if (index_x2a_Sx_soilthick(k) == 0) call shr_sys_abort('index_x2a_Sx_soilthick is zero')
    
    index_x2a_Sx_soilt(k)   = shr_string_listGetIndexF(seq_flds_x2a_fields,'Sx_soilt'//slayer(k) )
    if (index_x2a_Sx_soilt(k) == 0) call shr_sys_abort('index_x2a_Sx_soilt is zero')
    
    index_x2a_Sx_soilm(k)   = shr_string_listGetIndexF(seq_flds_x2a_fields,'Sx_soilm'//slayer(k) )
    if (index_x2a_Sx_soilm(k) == 0) call shr_sys_abort('index_x2a_Sx_soilm is zero')
    end do
...
!-------------------------------------------------------------------------------------- 
    do k = 1, num_soil_layers   
    index_l2x_Sl_soildepth(k)   = shr_string_listGetIndexF(seq_flds_l2x_fields,'Sl_soildepth'//slayer(k) )
    if (index_l2x_Sl_soildepth(k) == 0) call shr_sys_abort('index_l2x_Sl_soildepth is zero')

    index_l2x_Sl_soilthick(k)   = shr_string_listGetIndexF(seq_flds_l2x_fields,'Sl_soilthick'//slayer(k) )
    if (index_l2x_Sl_soilthick(k) == 0) call shr_sys_abort('index_l2x_Sl_soilthick is zero')

    index_l2x_Sl_soilt(k)   = shr_string_listGetIndexF(seq_flds_l2x_fields,'Sl_soilt'//slayer(k) )
    if (index_l2x_Sl_soilt(k) == 0) call shr_sys_abort('index_l2x_Sl_soilt is zero')

    index_l2x_Sl_soilm(k)   = shr_string_listGetIndexF(seq_flds_l2x_fields,'Sl_soilm'//slayer(k) )
    if (index_l2x_Sl_soilm(k) == 0) call shr_sys_abort('index_l2x_Sl_soilm is zero')
    enddo
