!===============================================================================
! SVN $Id: seq_infodata_mod.F90 28202 2011-04-29 23:30:47Z tcraig $
! SVN $URL: https://svn-ccsm-models.cgd.ucar.edu/drv/seq_mct/branch_tags/t3148b_tags/t3148b02_drvseq3_1_48/shr/seq_infodata_mod.F90 $
!===============================================================================
!BOP ===========================================================================
!
...
!EOP
   ...
   type seq_infodata_type
      ...
      logical                 :: wrf_present     ! by juanxiong he for wrf/cam coupling
      logical                 :: wrf_prognostic  ! by juanxiong he for wrf/cam coupling      
      integer(SHR_KIND_IN)    :: wrf_nx          ! by juanxiong he for wrf/cam coupling
      integer(SHR_KIND_IN)    :: wrf_ny          ! by juanxiong he for wrf/cam coupling
      logical                 :: samegrid_wo     ! by juanxiong he for wrf/cam coupling
      logical                 :: samegrid_wl     ! by juanxiong he for wrf/cam coupling    
      logical                 :: samegrid_wa     ! by juanxiong he for wrf/cam coupling

      logical                 :: geatm_present     ! by juanxiong he for geatm/cam coupling
      logical                 :: geatm_prognostic  ! by juanxiong he for geatm/cam coupling      
      integer(SHR_KIND_IN)    :: geatm_nx          ! by juanxiong he for geatm/cam coupling
      integer(SHR_KIND_IN)    :: geatm_ny          ! by juanxiong he for geatm/cam coupling
      logical                 :: samegrid_geo     ! by juanxiong he for geatm/cam coupling
      logical                 :: samegrid_gel     ! by juanxiong he for geatm/cam coupling    
      logical                 :: samegrid_gea     ! by juanxiong he for geatm/cam coupling
      ...
      integer(SHR_KIND_IN)    :: wrf_phase       ! by juanxiong hefor wrf/cam coupling  
      integer(SHR_KIND_IN)    :: geatm_phase       ! by juanxiong hefor wrf/cam coupling  
...
!EOP
    ...
    logical                :: samegrid_wo        ! are wrf and ocean grids same, juanxiong he
    logical                :: samegrid_wl        ! are wrf and land grids same, juanxiong he
    logical                :: samegrid_wa        ! are wrf and cam grids same, juanxiong he 
    logical                :: samegrid_geo        ! are wrf and ocean grids same, juanxiong he 
    logical                :: samegrid_gel        ! are wrf and land grids same, juanxiong he 
    logical                :: samegrid_gea        ! are wrf and cam grids same, juanxiong he 
    logical                :: shr_map_dopole     ! pole corrections in shr_map_mod
    ...
    namelist /seq_infodata_inparm/  &
         ...
         samegrid_wa, samegrid_wo, samegrid_wl,            &  ! by juanxiong he for wrf/cam coupling
         samegrid_gea, samegrid_geo, samegrid_gel,            &  ! by juanxiong he for wrf/cam coupling
...
!-------------------------------------------------------------------------------
    ...
    if (seq_comm_iamroot(ID)) then
       ...
       samegrid_wo           = .true.  ! by juanxiong he for wrf/cam coupling
       samegrid_wl           = .true.   ! by juanxiong he for wrf/cam coupling 
       samegrid_wa           = .true.  ! by juanxiong he for wrf/cam coupling  
       samegrid_geo           = .true.  ! by juanxiong he for wrf/cam coupling
       samegrid_gel           = .true.   ! by juanxiong he for wrf/cam coupling 
       samegrid_gea           = .true.  ! by juanxiong he for wrf/cam coupling 
       shr_map_dopole        = .true.
       vect_map              = 'npfix'
       aoflux_grid           = 'ocn'
       ...
       infodata%samegrid_wo           = samegrid_wo  ! by juanxiong he for wrf/cam coupling
       infodata%samegrid_wl           = samegrid_wl  ! by juanxiong he for wrf/cam coupling 
       infodata%samegrid_wa           = samegrid_wa  ! by juanxiong he for wrf/cam coupling  
       infodata%samegrid_geo           = samegrid_geo  ! by juanxiong he for wrf/cam coupling
       infodata%samegrid_gel           = samegrid_gel  ! by juanxiong he for wrf/cam coupling 
       infodata%samegrid_gea           = samegrid_gea  ! by juanxiong he for wrf/cam coupling  
       ...
       infodata%wrf_present = .true.     ! by juanxiong he for wrf/cam cooupling
       infodata%wrf_prognostic = .true. ! by juanxiong he for wrf/cam cooupling     
       infodata%wrf_nx = 0  ! by juanxiong he for wrf/cam cooupling
       infodata%wrf_ny = 0  ! by juanxiong he for wrf/cam cooupling
       infodata%wrf_phase = 1  ! by juanxiong he for wrf/cam cooupling

       infodata%geatm_present = .true.     ! by juanxiong he for geatm/cam cooupling
       infodata%geatm_prognostic = .true. ! by juanxiong he for geatm/cam cooupling     
       infodata%geatm_nx = 0  ! by juanxiong he for geatm/cam cooupling
       infodata%geatm_ny = 0  ! by juanxiong he for geatm/cam cooupling
       infodata%geatm_phase = 1  ! by juanxiong he for geatm/cam cooupling
    ...
    if (seq_comm_iamroot(ID)) then
       if (infodata%aqua_planet) then
          ...
          infodata%sno_present = .false.
          infodata%wrf_present = .false.! by juanxiong he for wrf/cam cooupling   
       end if
...
SUBROUTINE seq_infodata_GetData( infodata, case_name, case_desc, timing_dir,  &
           ...
           wrf_present, wrf_prognostic, wrf_nx, wrf_ny, wrf_phase,            &! by juanxiong he for wrf/cam cooupling
           samegrid_wo, samegrid_wl, samegrid_wa,                             &! by juanxiong he for wrf/cam cooupling
           geatm_present, geatm_prognostic, geatm_nx, geatm_ny, geatm_phase,  &! by juanxiong he for wrf/cam cooupling
           samegrid_geo, samegrid_gel, samegrid_gea,                             &! by juanxiong he for wrf/cam cooupling
           ...
           glc_g2supdate, atm_aero, run_barriers,                             &
...
! !INPUT/OUTPUT PARAMETERS:
   ...
   logical,             optional, intent(OUT) :: wrf_present          ! by juanxiong he for wrf/cam cooupling
   logical,             optional, intent(OUT) :: wrf_prognostic       ! by juanxiong he for wrf/cam cooupling
   integer(SHR_KIND_IN),optional, intent(OUT) :: wrf_nx          ! by juanxiong he for wrf/cam cooupling
   integer(SHR_KIND_IN),optional, intent(OUT) :: wrf_ny       ! by juanxiong he for wrf/cam cooupling
   integer(SHR_KIND_IN),optional, intent(OUT) :: wrf_phase       ! by juanxiong he for wrf/cam cooupling
   logical             ,optional, intent(OUT) :: samegrid_wo   ! by juanxiong he for wrf/cam cooupling
   logical             ,optional, intent(OUT) :: samegrid_wl   ! by juanxiong he for wrf/cam cooupling   
   logical             ,optional, intent(OUT) :: samegrid_wa   ! by juanxiong he for wrf/cam cooupling   
   
   logical,             optional, intent(OUT) :: geatm_present          ! by juanxiong he for wrf/cam cooupling
   logical,             optional, intent(OUT) :: geatm_prognostic       ! by juanxiong he for wrf/cam cooupling
   integer(SHR_KIND_IN),optional, intent(OUT) :: geatm_nx          ! by juanxiong he for wrf/cam cooupling
   integer(SHR_KIND_IN),optional, intent(OUT) :: geatm_ny       ! by juanxiong he for wrf/cam cooupling
   integer(SHR_KIND_IN),optional, intent(OUT) :: geatm_phase       ! by juanxiong he for wrf/cam cooupling
   logical             ,optional, intent(OUT) :: samegrid_geo   ! by juanxiong he for wrf/cam cooupling
   logical             ,optional, intent(OUT) :: samegrid_gel   ! by juanxiong he for wrf/cam cooupling   
   logical             ,optional, intent(OUT) :: samegrid_gea   ! by juanxiong he for wrf/cam cooupling 
...
!-------------------------------------------------------------------------------
    ...
    if ( present(wrf_present)   ) wrf_present   = infodata%wrf_present       ! by juanxiong he for wrf/cam cooupling
    if ( present(wrf_prognostic)   ) wrf_prognostic   = infodata%wrf_prognostic       ! by juanxiong he for wrf/cam cooupling
    if ( present(wrf_nx)   ) wrf_nx   = infodata%wrf_nx       ! by juanxiong he for wrf/cam cooupling
    if ( present(wrf_ny)   ) wrf_ny   = infodata%wrf_ny       ! by juanxiong he for wrf/cam cooupling
    if ( present(wrf_phase)   ) wrf_phase   = infodata%wrf_phase     ! by juanxiong he for wrf/cam cooupling
    if ( present(samegrid_wo)    ) samegrid_wo    = infodata%samegrid_wo  ! by juanxiong he for wrf/cam cooupling
    if ( present(samegrid_wl)    ) samegrid_wl    = infodata%samegrid_wl  ! by juanxiong he for wrf/cam cooupling    
    if ( present(samegrid_wa)    ) samegrid_wa    = infodata%samegrid_wa  ! by juanxiong he for wrf/cam cooupling

    if ( present(geatm_present)   ) geatm_present   = infodata%geatm_present       ! by juanxiong he for wrf/cam cooupling
    if ( present(geatm_prognostic)   ) geatm_prognostic   = infodata%geatm_prognostic ! by juanxiong he for wrf/cam cooupling
    if ( present(geatm_nx)   ) geatm_nx   = infodata%geatm_nx       ! by juanxiong he for wrf/cam cooupling
    if ( present(geatm_ny)   ) geatm_ny   = infodata%geatm_ny       ! by juanxiong he for wrf/cam cooupling
    if ( present(geatm_phase)   ) geatm_phase   = infodata%geatm_phase     ! by juanxiong he for wrf/cam cooupling
    if ( present(samegrid_geo)    ) samegrid_geo    = infodata%samegrid_geo  ! by juanxiong he for wrf/cam cooupling
    if ( present(samegrid_gel)    ) samegrid_gel    = infodata%samegrid_gel  ! by juanxiong he for wrf/cam cooupling    
    if ( present(samegrid_gea)    ) samegrid_gea    = infodata%samegrid_gea  ! by juanxiong he for wrf/cam cooupling
...
! !INPUT/OUTPUT PARAMETERS:
   ...
   logical,             optional, intent(IN) :: wrf_present          ! by juanxiong he for wrf/cam cooupling
   logical,             optional, intent(IN) :: wrf_prognostic       ! by juanxiong he for wrf/cam cooupling
   integer(SHR_KIND_IN),optional, intent(IN) :: wrf_nx          ! by juanxiong he for wrf/cam cooupling
   integer(SHR_KIND_IN),optional, intent(IN) :: wrf_ny       ! by juanxiong he for wrf/cam cooupling
   integer(SHR_KIND_IN),optional, intent(IN) :: wrf_phase       ! by juanxiong he for wrf/cam cooupling
   logical             ,optional, intent(IN) :: samegrid_wo   ! by juanxiong he for wrf/cam cooupling
   logical             ,optional, intent(IN) :: samegrid_wl   ! by juanxiong he for wrf/cam cooupling   
   logical             ,optional, intent(IN) :: samegrid_wa   ! by juanxiong he for wrf/cam cooupling 

   logical,             optional, intent(IN) :: geatm_present          ! by juanxiong he for wrf/cam cooupling
   logical,             optional, intent(IN) :: geatm_prognostic       ! by juanxiong he for wrf/cam cooupling
   integer(SHR_KIND_IN),optional, intent(IN) :: geatm_nx          ! by juanxiong he for wrf/cam cooupling
   integer(SHR_KIND_IN),optional, intent(IN) :: geatm_ny       ! by juanxiong he for wrf/cam cooupling
   integer(SHR_KIND_IN),optional, intent(IN) :: geatm_phase       ! by juanxiong he for wrf/cam cooupling
   logical             ,optional, intent(IN) :: samegrid_geo   ! by juanxiong he for wrf/cam cooupling
   logical             ,optional, intent(IN) :: samegrid_gel   ! by juanxiong he for wrf/cam cooupling   
   logical             ,optional, intent(IN) :: samegrid_gea   ! by juanxiong he for wrf/cam cooupling 
...
!-------------------------------------------------------------------------------
    ...
    if ( present(wrf_present)   ) infodata%wrf_present = wrf_present    ! by juanxiong he for wrf/cam cooupling
    if ( present(wrf_prognostic)   ) infodata%wrf_prognostic =  wrf_prognostic  ! by juanxiong he for wrf/cam cooupling
    if ( present(wrf_nx)   ) infodata%wrf_nx =   wrf_nx          ! by juanxiong he for wrf/cam cooupling
    if ( present(wrf_ny)   ) infodata%wrf_ny =   wrf_ny          ! by juanxiong he for wrf/cam cooupling
    if ( present(wrf_phase)   ) infodata%wrf_phase =   wrf_phase          ! by juanxiong he for wrf/cam cooupling
    if ( present(samegrid_wo)    ) infodata%samegrid_wo    = samegrid_wo  ! by juanxiong he for wrf/cam cooupling
    if ( present(samegrid_wl)    ) infodata%samegrid_wl    = samegrid_wl  ! by juanxiong he for wrf/cam cooupling   
    if ( present(samegrid_wa)    ) infodata%samegrid_wa    = samegrid_wa  ! by juanxiong he for wrf/cam cooupling 
...
!-------------------------------------------------------------------------------
    ...
    call shr_mpi_bcast(infodata%wrf_present,           mpicom)          ! by juanxiong he for wrf/cam cooupling
    call shr_mpi_bcast(infodata%wrf_prognostic,        mpicom)          ! by juanxiong he for wrf/cam cooupling
    call shr_mpi_bcast(infodata%wrf_nx,                mpicom)          ! by juanxiong he for wrf/cam cooupling
    call shr_mpi_bcast(infodata%wrf_ny,                mpicom)          ! by juanxiong he for wrf/cam cooupling
    call shr_mpi_bcast(infodata%wrf_phase,             mpicom)          ! by juanxiong he for wrf/cam cooupling
    call shr_mpi_bcast(infodata%samegrid_wo,           mpicom)          ! by juanxiong he for wrf/cam cooupling
    call shr_mpi_bcast(infodata%samegrid_wl,           mpicom)          ! by juanxiong he for wrf/cam cooupling    
    call shr_mpi_bcast(infodata%samegrid_wa,           mpicom)          ! by juanxiong he for wrf/cam cooupling 

    call shr_mpi_bcast(infodata%geatm_present,           mpicom)          ! by juanxiong he for wrf/cam cooupling
    call shr_mpi_bcast(infodata%geatm_prognostic,        mpicom)          ! by juanxiong he for wrf/cam cooupling
    call shr_mpi_bcast(infodata%geatm_nx,                mpicom)          ! by juanxiong he for wrf/cam cooupling
    call shr_mpi_bcast(infodata%geatm_ny,                mpicom)          ! by juanxiong he for wrf/cam cooupling
    call shr_mpi_bcast(infodata%geatm_phase,             mpicom)          ! by juanxiong he for wrf/cam cooupling
    call shr_mpi_bcast(infodata%samegrid_geo,           mpicom)          ! by juanxiong he for wrf/cam cooupling
    call shr_mpi_bcast(infodata%samegrid_gel,           mpicom)          ! by juanxiong he for wrf/cam cooupling    
    call shr_mpi_bcast(infodata%samegrid_gea,           mpicom)          ! by juanxiong he for wrf/cam cooupling 
...
!EOP
  ...
  logical :: wrf2cpli,wrf2cplr ! by juanxiong hefor wrf/cam coupling  
  logical :: gea2cpli,gea2cplr ! by juanxiong hefor wrf/cam coupling  
...
!-------------------------------------------------------------------------------
  ...
  wrf2cpli = .false. ! by juanxiong hefor wrf/cam coupling
  wrf2cplr = .false.! by juanxiong hefor wrf/cam coupling
  gea2cpli = .false. ! by juanxiong hefor wrf/cam coupling
  gea2cplr = .false.! by juanxiong hefor wrf/cam coupling

  ! --- translate type into logicals ---
  if (trim(type) == 'gea2cpl_init')then ! by juanxiong hefor wrf/cam coupling
     gea2cpli = .true.
     gea2cplr = .true.
     logset = .true.
  endif
  if (trim(type) == 'gea2cpl_run')then  ! by juanxiong hefor wrf/cam coupling     
     gea2cplr = .true.
     logset = .true.
  endif

  if (trim(type) == 'wrf2cpl_init')then ! by juanxiong hefor wrf/cam coupling
     wrf2cpli = .true.
     wrf2cplr = .true.
     logset = .true.
  endif
  if (trim(type) == 'wrf2cpl_run')then  ! by juanxiong hefor wrf/cam coupling     
     wrf2cplr = .true.
     logset = .true.
  endif         
  ...
  if (trim(type) == 'cpl2wrf_init' .or. &  ! by juanxiong hefor wrf/cam coupling
      trim(type) == 'cpl2gea_init' .or. &  ! by juanxiong hefor wrf/cam coupling
      trim(type) == 'cpl2atm_init' .or. &
  ...
  if (trim(type) == 'cpl2wrf_run' .or. &  ! by juanxiong hefor wrf/cam coupling
      trim(type) == 'cpl2gea_run' .or. &  ! by juanxiong hefor wrf/cam coupling
      trim(type) == 'cpl2atm_run' .or. &
  ...
  if (wrf2cpli) then                                  ! by juanxiong hefor wrf/cam coupling
    call shr_mpi_bcast(infodata%wrf_present,      mpicom,pebcast=pebcast)
    call shr_mpi_bcast(infodata%wrf_prognostic,   mpicom,pebcast=pebcast)
    call shr_mpi_bcast(infodata%wrf_nx,           mpicom,pebcast=pebcast)
    call shr_mpi_bcast(infodata%wrf_ny,           mpicom,pebcast=pebcast)
  ...
  if (gea2cpli) then                                  ! by juanxiong hefor wrf/cam coupling
    call shr_mpi_bcast(infodata%geatm_present,      mpicom,pebcast=pebcast)
    call shr_mpi_bcast(infodata%geatm_prognostic,   mpicom,pebcast=pebcast)
    call shr_mpi_bcast(infodata%geatm_nx,           mpicom,pebcast=pebcast)
    call shr_mpi_bcast(infodata%geatm_ny,           mpicom,pebcast=pebcast)
    ! dead_comps is true if it's ever set to true
    deads = infodata%dead_comps
    call shr_mpi_bcast(deads,                     mpicom,pebcast=pebcast)
    if (deads .or. infodata%dead_comps) infodata%dead_comps = .true.
  ...
  if (cpl2i) then
    call shr_mpi_bcast(infodata%wrf_present,      mpicom,pebcast=pebcast)           ! by juanxiong hefor wrf/cam coupling
    call shr_mpi_bcast(infodata%wrf_prognostic,   mpicom,pebcast=pebcast)           ! by juanxiong hefor wrf/cam coupling      
    call shr_mpi_bcast(infodata%geatm_present,      mpicom,pebcast=pebcast)         ! by juanxiong hefor wrf/cam coupling
    call shr_mpi_bcast(infodata%geatm_prognostic,   mpicom,pebcast=pebcast)         ! by juanxiong hefor wrf/cam coupling
    call shr_mpi_bcast(infodata%atm_present,      mpicom,pebcast=pebcast)
    call shr_mpi_bcast(infodata%atm_prognostic,   mpicom,pebcast=pebcast)
    call shr_mpi_bcast(infodata%lnd_present,      mpicom,pebcast=pebcast)
    call shr_mpi_bcast(infodata%lnd_prognostic,   mpicom,pebcast=pebcast)
...
!    if (loglevel > 0) then
     ...
     elseif (trim(infodata%orb_mode) == trim(seq_infodata_orb_variable_year)) then
       ...
       write(logunit,F0L) subname,'samegrid_wa              = ', infodata%samegrid_wa               ! by juanxiong hefor wrf/cam coupling       
       write(logunit,F0L) subname,'samegrid_wo              = ', infodata%samegrid_wo               ! by juanxiong hefor wrf/cam coupling
       write(logunit,F0L) subname,'samegrid_wl              = ', infodata%samegrid_wl               ! by juanxiong hefor wrf/cam coupling        
       write(logunit,F0L) subname,'wrf_present              = ', infodata%wrf_present               ! by juanxiong hefor wrf/cam coupling
       write(logunit,F0L) subname,'wrf_prognostic           = ', infodata%wrf_prognostic            ! by juanxiong hefor wrf/cam coupling              
       write(logunit,F0I) subname,'wrf_nx              = ', infodata%wrf_nx         ! by juanxiong hefor wrf/cam coupling
       write(logunit,F0I) subname,'wrf_ny              = ', infodata%wrf_ny         ! by juanxiong hefor wrf/cam coupling       
       write(logunit,F0I) subname,'wrf_phase           = ', infodata%wrf_phase      ! by juanxiong hefor wrf/cam coupling  

       write(logunit,F0L) subname,'samegrid_gea              = ', infodata%samegrid_gea               ! by juanxiong hefor wrf/cam coupling       
       write(logunit,F0L) subname,'samegrid_geo              = ', infodata%samegrid_geo               ! by juanxiong hefor wrf/cam coupling
       write(logunit,F0L) subname,'samegrid_gel              = ', infodata%samegrid_gel               ! by juanxiong hefor wrf/cam coupling        
       write(logunit,F0L) subname,'geatm_present              = ', infodata%geatm_present               ! by juanxiong hefor wrf/cam coupling
       write(logunit,F0L) subname,'geatm_prognostic           = ', infodata%geatm_prognostic            ! by juanxiong hefor wrf/cam coupling              
       write(logunit,F0I) subname,'geatm_nx              = ', infodata%geatm_nx ! by juanxiong hefor wrf/cam coupling
       write(logunit,F0I) subname,'geatm_ny              = ', infodata%geatm_ny ! by juanxiong hefor wrf/cam coupling       
       write(logunit,F0I) subname,'geatm_phase           = ', infodata%geatm_phase ! by juanxiong hefor wrf/cam coupling
