...
subroutine seq_rearr_avExtend(AVin,IDin,ID)
  ...
  integer :: ierr
  integer :: nints
!  character(len=1024) :: iList,rList  ! comment for huge varaibles in wrf/cam coupling by juanxiong he
  character(len=8000) :: iList,rList  ! increase up to 8000 or huge varaibles in wrf/cam coupling by juanxiong he
...
subroutine seq_rearr_avCreate(AVin,IDin,AVout,ID,lsize)
  ...
  integer :: ierr
  integer :: nints
!  character(len=1024) :: iList,rList  ! juanxiong he
  character(len=8000) :: iList,rList    ! juanxiong he
