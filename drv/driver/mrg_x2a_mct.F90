...
!--------------------------------------------------------------------------------------                
          do k=1,num_soil_layers
           x2a_a%rAttr(index_x2a_Sx_soildepth(k),n)  = l2x_a%rAttr(index_l2x_sl_soildepth(k),n)
           x2a_a%rAttr(index_x2a_Sx_soilthick(k),n)  = l2x_a%rAttr(index_l2x_sl_soilthick(k),n)
           x2a_a%rAttr(index_x2a_Sx_soilt(k),n)  = l2x_a%rAttr(index_l2x_sl_soilt(k),n)
           x2a_a%rAttr(index_x2a_Sx_soilm(k),n)  = l2x_a%rAttr(index_l2x_sl_soilm(k),n)
          enddo
!--------------------------------------------------------------------------------------
! soil depth/height and soil temperature/moisture for wrf/cam coupling, added juanxiong he 
!-------------------------------------------------------------------------------------- 
