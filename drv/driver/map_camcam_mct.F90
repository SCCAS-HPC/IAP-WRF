...
!--------------------------------------------------------------------------
  ...
  public :: map_cam2cam_init_mct
  public :: map_camx2cama_mct
  public :: map_cama2camx_mct

  ! Note ccc is component, xxx is driver/coupler

  interface map_cam2cam_init_mct; module procedure &
    map_ccc2ccc_init_mct
  end interface
  interface map_camx2cama_mct; module procedure &
    map_xxx2ccc_mct
  end interface
  interface map_cama2camx_mct; module procedure &
    map_ccc2xxx_mct
  end interface
...
!--------------------------------------------------------------------------
  ...
  character(*),parameter :: subName = '(map_camcam_mct)'
...
!=======================================================================
  ...
  subroutine map_ccc2ccc_init_mct( cdata_cc, x2c_cc, c2x_cc, ID_cc, &
    ...
    ! Local Variables
    !
    character(len=*),parameter :: subname = "(map_cam2cam_init_mct) "
...
!=======================================================================
  ...
  subroutine map_ccc2xxx_mct( cdata_cc, av_cc, cdata_cx, av_cx, fldlist )
    ...
    !-----------------------------------------------------
    character(len=*),parameter :: subname = "(map_cama2camx_mct) "
...
!=======================================================================
  ...
  subroutine map_xxx2ccc_mct( cdata_cx, av_cx, cdata_cc, av_cc, fldlist)
    ...
    !-----------------------------------------------------
    character(len=*),parameter :: subname = "(map_camx2cama_mct) "
