...
!
! !LOCAL VARIABLES:
    integer :: g,i,k           ! Indices, juanxiong he
!
! !REVISION HISTORY:
! Author: Mariana Vertenstein
!
...
!-------------------------------------------------------------------------------------- 
       ...
       do k= 1, nlevgrnd       
       l2x_l%rAttr(index_l2x_sl_soildepth(k),i) = l2a%soildepth(g,k)
       l2x_l%rAttr(index_l2x_sl_soilthick(k),i) = l2a%soilthick(g,k)
       l2x_l%rAttr(index_l2x_sl_soilt(k),i) = l2a%soilt(g,k)
       l2x_l%rAttr(index_l2x_sl_soilm(k),i) = l2a%soilm(g,k)
       end do
!       print *,l2x_l%rAttr(index_l2x_sl_soildepth(1),i) 
